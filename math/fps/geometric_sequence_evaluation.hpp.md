...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"math/fps/geometric_sequence_evaluation.hpp\"\n\n\n\n#include\
    \ <algorithm>\n#include <cassert>\n#include <utility>\n#include <vector>\n\n#line\
    ...
    \  // namespace m1une\n\n\n"
  code: "#ifndef M1UNE_FPS_GEOMETRIC_SEQUENCE_EVALUATION_HPP\n#define M1UNE_FPS_GEOMETRIC_SEQUENCE_EVALUATION_HPP\
    \ 1\n\n#include <algorithm>\n#include <cassert>\n#include <utility>\n#include\
    \ <vector>\n\n#include \"formal_power_series.hpp\"\n\nnamespace m1une {\nnamespace\
    \ fps {\n\nnamespace internal {\n\ntemplate <class Mint>\nstd::vector<Mint> geometric_triangular_powers(Mint\
    \ ratio, int count) {\n    assert(count >= 0);\n    std::vector<Mint> result(count);\n\
