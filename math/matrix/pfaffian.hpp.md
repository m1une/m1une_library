...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"math/matrix/pfaffian.hpp\"\n\n\n\n#include <cassert>\n#include\
    ...
    \n\nnamespace m1une {\nnamespace matrix {\n\n// Returns the Pfaffian of an even-dimensional\
    \ alternating matrix over a field.\ntemplate <class T>\nT pfaffian(Matrix<T> matrix)\
    ...
    \       }\n    }\n    return result;\n}\n\n}  // namespace matrix\n}  // namespace\
    \ m1une\n\n\n"
  code: "#ifndef M1UNE_MATRIX_PFAFFIAN_HPP\n#define M1UNE_MATRIX_PFAFFIAN_HPP 1\n\n\
    #include <cassert>\n#include <utility>\n\n#include \"matrix.hpp\"\n\nnamespace\
    \ m1une {\nnamespace matrix {\n\n// Returns the Pfaffian of an even-dimensional\
    \ alternating matrix over a field.\ntemplate <class T>\nT pfaffian(Matrix<T> matrix)\
    \ {\n    assert(matrix.rows() == matrix.cols());\n    const int size = matrix.rows();\n\
