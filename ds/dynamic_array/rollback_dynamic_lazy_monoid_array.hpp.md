...
data:
  ...
  bundledCode: "#line 1 \"ds/dynamic_array/rollback_dynamic_lazy_monoid_array.hpp\"\
    ...
    \n#line 5 \"ds/dynamic_array/persistent_dynamic_lazy_monoid_array.hpp\"\n#include\
    \ <chrono>\n#include <concepts>\n#line 8 \"ds/dynamic_array/persistent_dynamic_lazy_monoid_array.hpp\"\
    \n#include <cstdint>\n#line 10 \"ds/dynamic_array/persistent_dynamic_lazy_monoid_array.hpp\"\
    ...
    \ m1une {\nnamespace ds {\nnamespace detail {\n\n// Node must have integer `l`\
    \ and `r` members. New nodes initially have no\n// owner; discard_unreferenced()\
    ...
    \ ActedMonoid::op_id());\n        return res;\n    }\n};\n\n}  // namespace ds\n\
    }  // namespace m1une\n\n\n#line 10 \"ds/dynamic_array/rollback_dynamic_lazy_monoid_array.hpp\"\
    ...
    \ RollbackDynamicLazyMonoidArray& other) { insert(this->size(), other); }\n  \
    \  void append(const Persistent& other) { insert(this->size(), other); }\n\n \
    \   void erase(int pos) { Base::commit(Base::persistent().erase(pos)); }\n   \
    \ void erase(int left, int right) { Base::commit(Base::persistent().erase(left,\
  ...
  code: "#ifndef M1UNE_DS_DYNAMIC_ARRAY_ROLLBACK_DYNAMIC_LAZY_MONOID_ARRAY_HPP\n#define\
    ...
    \ f); }\n    void apply_inplace(int left, int right, const F& f) { apply(left,\
    \ right, f); }\n};\n\n}  // namespace ds\n}  // namespace m1une\n\n#endif  //\
    \ M1UNE_DS_DYNAMIC_ARRAY_ROLLBACK_DYNAMIC_LAZY_MONOID_ARRAY_HPP\n"
  dependsOn:
