...
data:
  ...
  bundledCode: "#line 1 \"ds/bst/rollback_ordered_set.hpp\"\n\n\n\n#include <functional>\n\
    ...
    \    }\n};\n\n}  // namespace detail\n}  // namespace ds\n}  // namespace m1une\n\
    \n\n#line 1 \"ds/bst/persistent_ordered_set.hpp\"\n\n\n\n#line 6 \"ds/bst/persistent_ordered_set.hpp\"\
    ...
    \ }\n};\n\n}  // namespace ds\n}  // namespace m1une\n\n\n#line 9 \"ds/bst/rollback_ordered_set.hpp\"\
    \n\nnamespace m1une {\nnamespace ds {\n\ntemplate <class T, class Compare = std::less<T>>\n\
    struct RollbackOrderedSet\n    : detail::RollbackPersistentBase<PersistentOrderedSet<T,\
  ...
  code: "#ifndef M1UNE_DS_BST_ROLLBACK_ORDERED_SET_HPP\n#define M1UNE_DS_BST_ROLLBACK_ORDERED_SET_HPP\
    ...
    \ private:\n    using Persistent = PersistentOrderedSet<T, Compare>;\n    using\
    \ Base = detail::RollbackPersistentBase<Persistent>;\n\n   public:\n    using\
    \ Base::Base;\n\n    void clear() {\n        Base::commit(Base::persistent().clear());\n\
    \    }\n\n    bool insert(T key) {\n        bool inserted = !Base::persistent().contains(key);\n\
    \        Base::commit(Base::persistent().insert(std::move(key)));\n        return\
    \ inserted;\n    }\n\n    bool erase(const T& key) {\n        bool erased = Base::persistent().contains(key);\n\
