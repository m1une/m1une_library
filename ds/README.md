...
| [`range_query/`](range_query/) | Repeated range-query objects: cumulative sums, Fenwick trees, SWAG, static inversions/LIS/modes, sqrt decomposition/tables, wavelet matrices, and range-sort range-product queries |
