...
| [`wavelet_matrix/`](wavelet_matrix/) | `wavelet_matrix.hpp`, `dynamic_wavelet_matrix.hpp`, weighted `wavelet_matrix_sum.hpp` and `dynamic_wavelet_matrix_sum.hpp`, plus `wavelet_matrix_2d.hpp` for multidimensional orthogonal queries |
