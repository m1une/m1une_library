...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/circle_ray.test.cpp\"\n#define PROBLEM \"\
    ...
    \ double>> result;\n    for (int index = 0; index < intersection.contact_count;\
    ...
    \ direction = ray.through - ray.origin;\n        std::vector<Point<long double>>\
    ...
    \            }\n        );\n\n        auto actual = contact_points(circle_boundary_intersection(circle,\
