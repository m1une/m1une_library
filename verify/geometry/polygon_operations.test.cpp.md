...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/polygon_operations.test.cpp\"\n#define PROBLEM\
    ...
    \ 2);\n    crossing.through = P(-1, 2);\n    auto crossing_parts = clip(crossing,\
    \ region);\n    assert(crossing_parts.size() == 1);\n    assert(close(crossing_parts[0].begin,\
