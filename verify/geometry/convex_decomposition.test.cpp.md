...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/convex_decomposition.test.cpp\"\n#define\
    ...
    \ += FixedInt(static_cast<unsigned>(digit - '0'));\n        }\n        *this =\
    ...
    \             carry = current >> 64;\n            }\n        }\n        limbs_\
    \ = product;\n        return *this;\n    }\n\n    constexpr FixedInt& multiply_small(std::uint64_t\
    ...
    \        return result;\n    }\n\n    constexpr void multiply_unsigned_small(std::uint64_t\
    \ value) {\n        __uint128_t carry = 0;\n        for (std::size_t index = 0;\
    \ index < limb_count; ++index) {\n            const __uint128_t current =\n  \
    ...
    \ std::uint64_t quotient_low = low / divisor;\n            remainder = low % divisor;\n\
    ...
    \ < limb_count; ++offset) {\n            const std::size_t index = limb_count\
    \ - 1 - offset;\n            remainder = ((remainder << 32) | (value[index] >>\
    \ 32)) % divisor;\n            remainder =\n                ((remainder << 32)\
    \ | std::uint32_t(value[index])) % divisor;\n        }\n        return remainder;\n\
    \    }\n\n};\n\n}  // namespace detail\n}  // namespace utilities\n}  // namespace\
    ...
    \        Point<long double>(first.a),\n        closest_point_on_segment(second,\
