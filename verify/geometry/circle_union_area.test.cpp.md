...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/circle_union_area.test.cpp\"\n#define PROBLEM\
    ...
    }  // namespace m1une\n\n\n#line 4 \"verify/geometry/circle_union_area.test.cpp\"\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 6 \"verify/geometry/circle_union_area.test.cpp\"\
    \n\n#line 12 \"verify/geometry/circle_union_area.test.cpp\"\n\nnamespace {\n\n\
    ...
    \ double>{Point<long double>(0, 7), 1});\n    assert(close(circle_union_area(circles),\
    ...
    \ 0), 3});\n    circles.push_back(Circle<long double>{Point<long double>(3, 0),\
    ...
    \ double>> circles(3);\n    circles[0] = Circle<long double>{Point<long double>(0,\
    \ 0), 1};\n    circles[1] = Circle<long double>{Point<long double>(side, 0), 1};\n\
    \    circles[2] = Circle<long double>{\n        Point<long double>(side / 2.0L,\
    \ height),\n        1\n    };\n    long double pair_intersection =\n        circle_circle_intersection_area(circles[0],\
    \ circles[1]);\n    long double expected =\n        3.0L * std::numbers::pi_v<long\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include \"\
    ...
    \    assert(circle_union_area(circles) == 0.0L);\n\n    circles.push_back(Circle<long\
    \ double>{Point<long double>(3, -4), 0});\n    assert(circle_union_area(circles)\
    \ == 0.0L);\n\n    circles.push_back(Circle<long double>{Point<long double>(0,\
    \ 0), 3});\n    circles.push_back(Circle<long double>{Point<long double>(0, 0),\
  ...
  verifiedWith: []
documentation_of: verify/geometry/circle_union_area.test.cpp
layout: document
redirect_from:
- /verify/verify/geometry/circle_union_area.test.cpp
- /verify/verify/geometry/circle_union_area.test.cpp.html
