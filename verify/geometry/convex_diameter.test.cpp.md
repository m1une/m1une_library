...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/convex_diameter.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_B\"\n\n#line\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 8 \"verify/geometry/convex_diameter.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_B\"\
    ...
    \    std::vector<Point> polygon(size);\n    for (Point& point : polygon) fast_input\
    \ >> point.x >> point.y;\n\n    const long double answer =\n        std::sqrt(m1une::geometry::convex_diameter2(std::move(polygon)));\n\
    \    fast_output.set_fixed(12);\n    fast_output << answer << '\\n';\n}\n"
  dependsOn:
...
layout: document
redirect_from:
- /verify/verify/geometry/convex_diameter.test.cpp
- /verify/verify/geometry/convex_diameter.test.cpp.html
