...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/circumcircle.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_C\"\n#define\
    ...
    }  // namespace m1une\n\n\n#line 5 \"verify/geometry/circumcircle.test.cpp\"\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_C\"\
    ...
    \ = circumcircle(first, second, third);\n    assert(result.has_value());\n   \
    \ fast_output.set_fixed(15);\n    fast_output << result->center.x << \" \" <<\
    \ result->center.y << \" \"\n                << result->radius << '\\n';\n}\n"
  dependsOn:
  - geometry/circle.hpp
  - geometry/linear.hpp
  ...
  verifiedWith: []
documentation_of: verify/geometry/circumcircle.test.cpp
layout: document
redirect_from:
- /verify/verify/geometry/circumcircle.test.cpp
- /verify/verify/geometry/circumcircle.test.cpp.html
