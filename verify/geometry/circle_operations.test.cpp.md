...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/circle_operations.test.cpp\"\n#define PROBLEM\
    ...
    \ Point<int>(5, 3)));\n    assert(close(circle_area(circle), 25.0L * std::numbers::pi_v<long\
    ...
    \ 0.25L);\n    small_square.emplace_back(-0.25L, 0.25L);\n    assert(close(circle_polygon_intersection_area(first,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include \"\
    ...
    \ == PointInCircle::Inside);\n    assert(point_in_circle(circle, Point<int>(5,\
    \ 3)) == PointInCircle::Boundary);\n    assert(point_in_circle(circle, Point<int>(8,\
    \ -1)) == PointInCircle::Outside);\n    assert(contains(circle, Point<int>(5,\
    \ 3)));\n    assert(on_circle(circle, Point<int>(5, 3)));\n    assert(close(circle_area(circle),\
