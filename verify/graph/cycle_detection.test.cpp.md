...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/cycle_detection.test.cpp\"\n#define PROBLEM\
    ...
    \        return *this;\n    }\n};\n\n}  // namespace utilities\n}  // namespace\
    \ m1une\n\n\n#line 7 \"verify/graph/cycle_detection.test.cpp\"\n\nint main() {\n\
    ...
    \ cycle = m1une::graph::find_directed_cycle(graph);\n    if (cycle.empty()) {\n\
    \        fast_output << -1 << '\\n';\n        return 0;\n    }\n    fast_output\
    \ << cycle.edge_ids.size() << '\\n';\n    for (int edge : cycle.edge_ids) fast_output\
    \ << edge << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/cycle_detection\"\n\n#include\
    ...
    \ edge : cycle.edge_ids) fast_output << edge << '\\n';\n}\n"
  dependsOn:
  - graph/cycle_detection.hpp
  - graph/graph.hpp
  - graph/graph.hpp
