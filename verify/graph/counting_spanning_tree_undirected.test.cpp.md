...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/counting_spanning_tree_undirected.test.cpp\"\
    ...
    \ vertex = 0; vertex < graph.size(); vertex++) {\n        for (const Edge<Weight>&\
    ...
    \ math\n}  // namespace m1une\n\n\n#line 5 \"verify/graph/counting_spanning_tree_undirected.test.cpp\"\
    \n\n#include <bit>\n#line 1 \"utilities/fast_io.hpp\"\n\n\n\n#include <algorithm>\n\
    #line 6 \"utilities/fast_io.hpp\"\n#include <cerrno>\n#include <charconv>\n#line\
    \ 9 \"utilities/fast_io.hpp\"\n#include <cstdio>\n#include <cstdlib>\n#line 12\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 9 \"verify/graph/counting_spanning_tree_undirected.test.cpp\"\
    \n#include <numeric>\n#include <random>\n#line 12 \"verify/graph/counting_spanning_tree_undirected.test.cpp\"\
    ...
    \      parent[second] = first;\n        return true;\n    }\n};\n\nmint naive_count(const\
    \ m1une::graph::Graph<int>& graph) {\n    const int n = graph.size();\n    const\
    \ std::vector<m1une::graph::Edge<int>> edges = graph.edges();\n    mint answer\
    ...
    \ connected && dsu.leader(vertex) == dsu.leader(0);\n        }\n        if (connected)\
    ...
    \ edge < edge_count; edge++) {\n            int from = int(random() % unsigned(n));\n\
    \            int to = int(random() % unsigned(n));\n            int weight = int(random()\
    \ % 5);\n            graph.add_edge(from, to, weight);\n        }\n        assert(m1une::graph::count_spanning_trees<mint>(graph)\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/counting_spanning_tree_undirected\"\
    ...
    \ int n = graph.size();\n    const std::vector<m1une::graph::Edge<int>> edges\
  ...
  verifiedWith: []
documentation_of: verify/graph/counting_spanning_tree_undirected.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/counting_spanning_tree_undirected.test.cpp
- /verify/verify/graph/counting_spanning_tree_undirected.test.cpp.html
