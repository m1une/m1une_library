...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/eulerian_trail_directed.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/eulerian_trail_directed\"\n\n#include\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 5 \"verify/graph/eulerian_trail_directed.test.cpp\"\
    \n#include <optional>\n#include <random>\n#line 8 \"verify/graph/eulerian_trail_directed.test.cpp\"\
    ...
    }\n\n}  // namespace graph\n}  // namespace m1une\n\n\n#line 11 \"verify/graph/eulerian_trail_directed.test.cpp\"\
    ...
    \        if (brute_directed_dfs(\n                edges[edge_id].second, edges,\
    \ used_mask | (1 << edge_id))) {\n            return true;\n        }\n    }\n\
    \    return false;\n}\n\nbool brute_directed(int vertex_count, const std::vector<std::pair<int,\
    \ int>>& edges) {\n    if (edges.empty()) return true;\n    for (int start = 0;\
    \ start < vertex_count; start++) {\n        if (brute_directed_dfs(start, edges,\
    ...
    \        assert(!used[edge_id]);\n        used[edge_id] = true;\n        assert(edges[edge_id].first\
    \ == trail.vertices[index]);\n        assert(edges[edge_id].second == trail.vertices[index\
    ...
    \    open.add_directed_edge(1, 2);\n    assert(m1une::graph::directed_eulerian_trail(open,\
    ...
    \ 0));\n}\n#endif\n\nvoid print(\n    const std::optional<m1une::graph::EulerianTrail>&\
    \ trail,\n    m1une::utilities::FastOutput& fast_output\n) {\n    if (!trail.has_value())\
    \ {\n        fast_output << \"No\\n\";\n        return;\n    }\n    fast_output\
    \ << \"Yes\\n\";\n    for (int index = 0; index < int(trail->vertices.size());\
  ...
  verifiedWith: []
documentation_of: verify/graph/eulerian_trail_directed.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/eulerian_trail_directed.test.cpp
- /verify/verify/graph/eulerian_trail_directed.test.cpp.html
