...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/enumerate_cliques.test.cpp\"\n#define PROBLEM\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 6 \"verify/graph/enumerate_cliques.test.cpp\"\
    \n\n#line 12 \"verify/graph/enumerate_cliques.test.cpp\"\n\nnamespace {\n\nvoid\
    ...
    \ canonical.end());\n                assert(\n                    std::adjacent_find(canonical.begin(),\
    \ canonical.end()) ==\n                    canonical.end()\n                );\n\
  ...
  verifiedWith: []
documentation_of: verify/graph/enumerate_cliques.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/enumerate_cliques.test.cpp
- /verify/verify/graph/enumerate_cliques.test.cpp.html
