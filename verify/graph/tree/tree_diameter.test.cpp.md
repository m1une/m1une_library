...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/tree/tree_diameter.test.cpp\"\n#define PROBLEM\
    ...
    \        return *this;\n    }\n};\n\n}  // namespace utilities\n}  // namespace\
    \ m1une\n\n\n#line 4 \"verify/graph/tree/tree_diameter.test.cpp\"\n\n#line 1 \"\
    ...
    \        m1une::tree::tree_diameter(graph);\n    fast_output << diameter.cost\
    \ << ' ' << diameter.vertices.size() << '\\n';\n    for (int i = 0; i < int(diameter.vertices.size());\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/tree_diameter\"\n\n#include\
    ...
    \        long long cost;\n        fast_input >> first >> second >> cost;\n   \
    \     graph.add_edge(first, second, cost);\n    }\n\n    m1une::tree::TreeDiameter<long\
    \ long> diameter =\n        m1une::tree::tree_diameter(graph);\n    fast_output\
    \ << diameter.cost << ' ' << diameter.vertices.size() << '\\n';\n    for (int\
    \ i = 0; i < int(diameter.vertices.size()); i++) {\n        if (i > 0) fast_output\
    \ << ' ';\n        fast_output << diameter.vertices[i];\n    }\n    fast_output\
    \ << '\\n';\n}\n"
  dependsOn:
  - utilities/fast_io.hpp
