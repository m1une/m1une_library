...
data:
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ALDS1_11_C\"\n\
    ...
    \ % 17 != 0) continue;\n                int edge = graph.add_directed_edge(from,\
    \ to);\n                if (random() % 11 == 0) graph.erase_edge(edge);\n    \
    \        }\n        }\n\n        int source_count = 1 + int(random() % size);\n\
    \        std::vector<int> sources;\n        for (int i = 0; i < source_count;\
  ...
  verifiedWith: []
documentation_of: verify/graph/bfs.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/bfs.test.cpp
- /verify/verify/graph/bfs.test.cpp.html
