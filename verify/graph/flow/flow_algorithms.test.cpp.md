...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/flow/flow_algorithms.test.cpp\"\n#define PROBLEM\
    ...
    \        return *this;\n    }\n};\n\n}  // namespace utilities\n}  // namespace\
    \ m1une\n\n\n#line 5 \"verify/graph/flow/flow_algorithms.test.cpp\"\n#include\
    \ <random>\n#line 7 \"verify/graph/flow/flow_algorithms.test.cpp\"\n#include <vector>\n\
    ...
    \n\n\n#line 10 \"verify/graph/flow/flow_algorithms.test.cpp\"\n\nvoid test_max_flow()\
    ...
    \ long> actual_balance(n, 0);\n        for (const auto& edge : result->edges)\
    \ {\n            assert(edge.lower <= edge.flow && edge.flow <= edge.upper);\n\
    \            actual_balance[edge.from] += edge.flow;\n            actual_balance[edge.to]\
    ...
    \   assert(actual_balance == required_balance);\n    }\n\n    m1une::flow::BMinCostFlow<long\
    \ long, long long> alias(1);\n    assert(alias.size() == 1);\n    m1une::flow::BMinCostFlow<long\
    \ long, long long, __int128_t> wide_alias(1);\n    assert(wide_alias.size() ==\
    \ 1);\n}\n\nvoid test_min_cost_flow() {\n    m1une::flow::MinCostFlow<long long,\
    ...
    \ long total_source_flow = 0;\n    for (const auto& e : edges) {\n        if (e.from\
    \ == 0) total_source_flow += e.flow;\n        assert(0 <= e.flow && e.flow <=\
