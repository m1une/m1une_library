...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/minimum_spanning_tree.test.cpp\"\n#define PROBLEM\
    ...
    \        return *this;\n    }\n};\n\n}  // namespace utilities\n}  // namespace\
    \ m1une\n\n\n#line 4 \"verify/graph/minimum_spanning_tree.test.cpp\"\n\n#line\
    ...
    \ cost;\n    std::vector<Edge<T>> edges;\n    int components;\n\n    bool is_spanning_tree(int\
    \ n) const {\n        return components <= 1 && int(edges.size()) == std::max(0,\
    \ n - 1);\n    }\n};\n\ntemplate <class T>\nMinimumSpanningForest<T> kruskal(const\
    ...
    \        result.components--;\n    }\n\n    return result;\n}\n\n}  // namespace\
    \ graph\n}  // namespace m1une\n\n\n#line 7 \"verify/graph/minimum_spanning_tree.test.cpp\"\
    ...
    \ second, cost);\n    }\n\n    m1une::graph::MinimumSpanningForest<long long>\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/minimum_spanning_tree\"\
    ...
    \    fast_output << result.cost << '\\n';\n    for (int i = 0; i < int(result.edges.size());\
    \ i++) {\n        if (i > 0) fast_output << ' ';\n        fast_output << result.edges[i].id;\n\
    \    }\n    fast_output << '\\n';\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/graph/minimum_spanning_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/minimum_spanning_tree.test.cpp
- /verify/verify/graph/minimum_spanning_tree.test.cpp.html
