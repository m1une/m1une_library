...
data:
  ...
  bundledCode: "#line 1 \"verify/convex/monge/min_plus_convolution_convex_arbitrary.test.cpp\"\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 4 \"verify/convex/monge/min_plus_convolution_convex_arbitrary.test.cpp\"\
    ...
    \ convex\n}  // namespace m1une\n\n\n#line 7 \"verify/convex/monge/min_plus_convolution_convex_arbitrary.test.cpp\"\
    \n\nint main() {\n    m1une::utilities::FastInput fast_input;\n    m1une::utilities::FastOutput\
    \ fast_output;\n\n    int n, m;\n    fast_input >> n >> m;\n    std::vector<long\
    \ long> convex(n), arbitrary(m);\n    for (long long& value : convex) fast_input\
    \ >> value;\n    for (long long& value : arbitrary) fast_input >> value;\n\n \
    \   constexpr long long infinity = 2'000'000'000'000'000'000LL;\n    std::vector<long\
    \ long> result =\n        m1une::convex::min_plus_convolution_convex(arbitrary,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/min_plus_convolution_convex_arbitrary\"\
    ...
    \ value : arbitrary) fast_input >> value;\n\n    constexpr long long infinity\
  ...
  verifiedWith: []
documentation_of: verify/convex/monge/min_plus_convolution_convex_arbitrary.test.cpp
layout: document
redirect_from:
- /verify/verify/convex/monge/min_plus_convolution_convex_arbitrary.test.cpp
- /verify/verify/convex/monge/min_plus_convolution_convex_arbitrary.test.cpp.html
