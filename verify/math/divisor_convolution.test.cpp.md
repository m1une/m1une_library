...
data:
  ...
  bundledCode: "#line 1 \"verify/math/divisor_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \ math\n}  // namespace m1une\n\n\n#line 5 \"verify/math/divisor_convolution.test.cpp\"\
    \n\n#line 9 \"verify/math/divisor_convolution.test.cpp\"\n#include <numeric>\n\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 12 \"verify/math/divisor_convolution.test.cpp\"\
    \n\nnamespace {\n\ntemplate <typename T>\nstd::vector<T> naive_gcd_convolution(\n\
    \    const std::vector<T>& first,\n    const std::vector<T>& second\n) {\n   \
    \ if (first.empty() || second.empty()) return {};\n    const std::size_t size\
    \ = first.size() > second.size()\n        ? first.size()\n        : second.size();\n\
    \    std::vector<T> result(size);\n    for (std::size_t i = 1; i < first.size();\
  ...
  verifiedWith: []
documentation_of: verify/math/divisor_convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/math/divisor_convolution.test.cpp
- /verify/verify/math/divisor_convolution.test.cpp.html
