...
data:
  ...
  bundledCode: "#line 1 \"verify/math/multivariate_convolution_truncated.test.cpp\"\
    ...
    \ has_static_modulus : std::false_type {};\n\ntemplate <class Mint>\nstruct has_static_modulus<\n\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 12 \"verify/math/multivariate_convolution_truncated.test.cpp\"\
    ...
    \        for (int& dimension : dimensions) {\n            dimension = 1 + int(random()\
    \ % 4);\n            size *= dimension;\n        }\n        std::vector<mint>\
    \ first(size), second(size);\n        for (mint& value : first) value = int(random()\
    \ % 101) - 50;\n        for (mint& value : second) value = int(random() % 101)\
