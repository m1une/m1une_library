...
data:
  ...
  bundledCode: "#line 1 \"verify/math/fps/polynomial_taylor_shift.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/polynomial_taylor_shift\"\n\n#line\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 4 \"verify/math/fps/polynomial_taylor_shift.test.cpp\"\
    \n\n#line 1 \"math/fps/formal_power_series.hpp\"\n\n\n\n#line 5 \"math/fps/formal_power_series.hpp\"\
    ...
    \ namespace fps\n}  // namespace m1une\n\n\n#line 7 \"verify/math/fps/polynomial_taylor_shift.test.cpp\"\
    \n\nusing mint = m1une::math::modint998244353;\nusing Fps = m1une::fps::FormalPowerSeries<mint>;\n\
    \nint main() {\n    m1une::utilities::FastInput fast_input;\n    m1une::utilities::FastOutput\
    \ fast_output;\n\n    int n;\n    mint shift;\n    fast_input >> n >> shift;\n\
    \    Fps a(n);\n    for (mint& value : a) fast_input >> value;\n    Fps result\
    \ = a.taylor_shift(shift);\n    for (int i = 0; i < n; i++) {\n        if (i)\
  ...
  verifiedWith: []
documentation_of: verify/math/fps/polynomial_taylor_shift.test.cpp
layout: document
redirect_from:
- /verify/verify/math/fps/polynomial_taylor_shift.test.cpp
- /verify/verify/math/fps/polynomial_taylor_shift.test.cpp.html
