...
data:
  ...
  bundledCode: "#line 1 \"verify/math/fps/lagrange_inversion.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n#include\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 6 \"verify/math/fps/lagrange_inversion.test.cpp\"\
    \n#include <random>\n#line 8 \"verify/math/fps/lagrange_inversion.test.cpp\"\n\
    \n#line 1 \"math/fps/lagrange_inversion.hpp\"\n\n\n\n#line 7 \"math/fps/lagrange_inversion.hpp\"\
    \n\n#line 1 \"math/fps/formal_power_series.hpp\"\n\n\n\n#line 7 \"math/fps/formal_power_series.hpp\"\
    \n#include <optional>\n#line 9 \"math/fps/formal_power_series.hpp\"\n#include\
    ...
    \ degree);\n}\n\n}  // namespace fps\n}  // namespace m1une\n\n\n#line 11 \"verify/math/fps/lagrange_inversion.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n\
    ...
    using Fps = m1une::fps::FormalPowerSeries<mint>;\n\nFps naive_multiply(const Fps&\
    \ a, const Fps& b, int degree) {\n    Fps result(degree);\n    for (int i = 0;\
    \ i < int(a.size()) && i < degree; i++) {\n        for (int j = 0; j < int(b.size())\
    \ && i + j < degree; j++) {\n            result[i + j] += a[i] * b[j];\n     \
    \   }\n    }\n    return result;\n}\n\nFps naive_compose(const Fps& outer, const\
    \ Fps& inner, int degree) {\n    Fps result(degree);\n    Fps power(degree);\n\
    \    if (degree != 0) power[0] = 1;\n    for (int i = 0; i < int(outer.size())\
    \ && i < degree; i++) {\n        for (int j = 0; j < degree; j++) result[j] +=\
    \ outer[i] * power[j];\n        power = naive_multiply(power, inner, degree);\n\
    \    }\n    return result;\n}\n\nFps naive_implicit_series(const Fps& phi, int\
    \ degree) {\n    Fps w(degree);\n    for (int iteration = 0; iteration < degree;\
