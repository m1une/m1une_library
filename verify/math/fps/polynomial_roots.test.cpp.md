...
data:
  ...
  bundledCode: "#line 1 \"verify/math/fps/polynomial_roots.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/polynomial_root_finding\"\n\n#include <algorithm>\n\
    #include <cassert>\n#include <cstdint>\n#include <vector>\n\n#line 1 \"math/fps/polynomial_roots.hpp\"\
    \n\n\n\n#line 7 \"math/fps/polynomial_roots.hpp\"\n#include <utility>\n#line 9\
    \ \"math/fps/polynomial_roots.hpp\"\n\n#line 1 \"math/fps/half_gcd.hpp\"\n\n\n\
    \n#line 5 \"math/fps/half_gcd.hpp\"\n#include <optional>\n#line 7 \"math/fps/half_gcd.hpp\"\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 11 \"verify/math/fps/polynomial_roots.test.cpp\"\
    ...
    \ coefficient : small) coefficient = SmallMint(next_random(random));\n       \
    \     if (small.back() == SmallMint(0)) small.back() = SmallMint(1);\n       \
    \     std::vector<SmallMint> brute;\n            for (int value = 0; value < 17;\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/polynomial_root_finding\"\
    ...
    \ >> 9;\n    return state;\n}\n\nvoid focused_tests() {\n    using Mint = m1une::math::modint998244353;\n\
    \    Fps<Mint> polynomial(1, Mint(7));\n    const std::vector<Mint> expected =\
    \ {Mint(0), Mint(1), Mint(5), Mint(123456)};\n    for (int copy = 0; copy < 3;\
    \ ++copy) polynomial *= linear_factor(expected[0]);\n    for (int copy = 0; copy\
    \ < 2; ++copy) polynomial *= linear_factor(expected[1]);\n    polynomial *= linear_factor(expected[2]);\n\
    \    polynomial *= linear_factor(expected[3]);\n    assert(m1une::fps::polynomial_roots(polynomial)\
    \ == expected);\n\n    Fps<Mint> no_roots(3);\n    no_roots[0] = Mint(0) - Mint(3);\n\
    \    no_roots[2] = Mint(1);\n    assert(m1une::fps::polynomial_roots(no_roots).empty());\n\
    \    assert(m1une::fps::polynomial_roots(Fps<Mint>(1, Mint(11))).empty());\n\n\
    \    using BinaryMint = m1une::math::ModInt<2>;\n    Fps<BinaryMint> binary(3);\n\
    \    binary[1] = BinaryMint(1);\n    binary[2] = BinaryMint(1);\n    const std::vector<BinaryMint>\
    \ binary_roots =\n        m1une::fps::polynomial_roots(binary);\n    assert(binary_roots.size()\
    \ == 2);\n    assert(binary_roots[0] == BinaryMint(0));\n    assert(binary_roots[1]\
    \ == BinaryMint(1));\n\n    using SmallMint = m1une::math::ModInt<17>;\n    uint64_t\
    \ random = 0x73c0582af1d946beULL;\n    for (int degree = 0; degree <= 10; ++degree)\
    \ {\n        for (int iteration = 0; iteration < 20; ++iteration) {\n        \
    \    Fps<SmallMint> small(degree + 1);\n            for (SmallMint& coefficient\
    \ : small) coefficient = SmallMint(next_random(random));\n            if (small.back()\
    \ == SmallMint(0)) small.back() = SmallMint(1);\n            std::vector<SmallMint>\
  ...
  verifiedWith: []
documentation_of: verify/math/fps/polynomial_roots.test.cpp
layout: document
redirect_from:
- /verify/verify/math/fps/polynomial_roots.test.cpp
- /verify/verify/math/fps/polynomial_roots.test.cpp.html
