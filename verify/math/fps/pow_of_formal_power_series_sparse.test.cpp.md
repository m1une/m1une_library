...
data:
  ...
  bundledCode: "#line 1 \"verify/math/fps/pow_of_formal_power_series_sparse.test.cpp\"\
    ...
    \        return *this;\n    }\n};\n\n}  // namespace utilities\n}  // namespace\
    \ m1une\n\n\n#line 4 \"verify/math/fps/pow_of_formal_power_series_sparse.test.cpp\"\
    \n\n#line 1 \"math/fps/sparse_formal_power_series.hpp\"\n\n\n\n#include <cassert>\n\
    #line 6 \"math/fps/sparse_formal_power_series.hpp\"\n#include <optional>\n#line\
    \ 8 \"math/fps/sparse_formal_power_series.hpp\"\n#include <vector>\n\n#line 1\
    ...
    \ fps\n}  // namespace m1une\n\n\n#line 7 \"verify/math/fps/pow_of_formal_power_series_sparse.test.cpp\"\
    \n\nusing mint = m1une::math::modint998244353;\nusing Sparse = m1une::fps::SparseFormalPowerSeries<mint>;\n\
    \nint main() {\n    m1une::utilities::FastInput fast_input;\n    m1une::utilities::FastOutput\
    \ fast_output;\n\n    int n, k;\n    long long exponent;\n    fast_input >> n\
    \ >> k >> exponent;\n    Sparse f(k);\n    for (auto& [degree, coefficient] :\
    \ f) fast_input >> degree >> coefficient;\n    auto result = m1une::fps::sparse_fps_pow(f,\
    \ exponent, n);\n    for (int i = 0; i < n; i++) {\n        if (i) fast_output\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/pow_of_formal_power_series_sparse\"\
    ...
    \n    int n, k;\n    long long exponent;\n    fast_input >> n >> k >> exponent;\n\
    \    Sparse f(k);\n    for (auto& [degree, coefficient] : f) fast_input >> degree\
  ...
  verifiedWith: []
documentation_of: verify/math/fps/pow_of_formal_power_series_sparse.test.cpp
layout: document
redirect_from:
- /verify/verify/math/fps/pow_of_formal_power_series_sparse.test.cpp
- /verify/verify/math/fps/pow_of_formal_power_series_sparse.test.cpp.html
