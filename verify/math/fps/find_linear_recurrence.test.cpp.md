...
data:
  ...
  bundledCode: "#line 1 \"verify/math/fps/find_linear_recurrence.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/find_linear_recurrence\"\n\n#include\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 8 \"verify/math/fps/find_linear_recurrence.test.cpp\"\
    \n\nusing mint = m1une::math::modint998244353;\n\nint main() {\n    m1une::utilities::FastInput\
    \ input;\n    m1une::utilities::FastOutput output;\n\n    int size = 0;\n    input.read(size);\n\
    \    std::vector<mint> sequence(size);\n    input.read(sequence);\n\n    std::vector<mint>\
    \ recurrence = m1une::fps::berlekamp_massey(sequence);\n    output.println(recurrence.size());\n\
  ...
  verifiedWith: []
documentation_of: verify/math/fps/find_linear_recurrence.test.cpp
layout: document
redirect_from:
- /verify/verify/math/fps/find_linear_recurrence.test.cpp
- /verify/verify/math/fps/find_linear_recurrence.test.cpp.html
