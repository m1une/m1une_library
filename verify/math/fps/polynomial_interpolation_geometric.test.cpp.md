...
data:
  ...
  bundledCode: "#line 1 \"verify/math/fps/polynomial_interpolation_geometric.test.cpp\"\
    ...
    \n\n\n\n#include <algorithm>\n#line 6 \"math/fps/geometric_sequence_evaluation.hpp\"\
    ...
    \ * power;\n        power *= ratio;\n    }\n    return result;\n}\n\ntemplate\
    \ <class Mint>\nstd::vector<Mint> geometric_batch_inverse(const std::vector<Mint>&\
    \ values) {\n    const int count = int(values.size());\n    std::vector<Mint>\
    \ prefix(count + 1, Mint(1));\n    for (int i = 0; i < count; ++i) {\n       \
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 10 \"verify/math/fps/polynomial_interpolation_geometric.test.cpp\"\
    \n\nnamespace {\n\nusing Mint = m1une::math::modint998244353;\nusing Fps = m1une::fps::FormalPowerSeries<Mint>;\n\
    \nuint64_t next_random(uint64_t& state) {\n    state ^= state << 7;\n    state\
    \ ^= state >> 9;\n    return state;\n}\n\nvoid check_interpolation(const Fps&\
    \ polynomial, Mint initial, Mint ratio) {\n    const std::vector<Mint> values\
    \ = m1une::fps::multipoint_evaluate_geometric(\n        polynomial, initial, ratio,\
    \ polynomial.size());\n    const Fps restored =\n        m1une::fps::polynomial_interpolate_geometric(values,\
    \ initial, ratio);\n    assert(restored == polynomial);\n}\n\nvoid focused_tests()\
    \ {\n    assert(m1une::fps::polynomial_interpolate_geometric<Mint>({}, Mint(0),\
    ...
    \ (int size = 2; size <= 30; ++size) {\n        Fps polynomial(size);\n      \
    \  for (Mint& coefficient : polynomial) {\n            coefficient = Mint(next_random(random)\
    \ % Mint::mod());\n        }\n        check_interpolation(polynomial, Mint(1 +\
    \ next_random(random) % (Mint::mod() - 1)),\n                            Mint(3));\n\
    \    }\n\n    const int order = 8;\n    const Mint root = Mint(3).pow((Mint::mod()\
    \ - 1) / order);\n    Fps cyclic(order);\n    for (Mint& coefficient : cyclic)\
    \ coefficient = Mint(next_random(random) % Mint::mod());\n    check_interpolation(cyclic,\
    \ Mint(5), root);\n}\n\n}  // namespace\n\nint main() {\n    m1une::utilities::FastInput\
    \ input;\n    m1une::utilities::FastOutput output;\n    focused_tests();\n\n \
    \   int count;\n    Mint initial, ratio;\n    input >> count >> initial >> ratio;\n\
    \    std::vector<Mint> values(count);\n    for (Mint& value : values) input >>\
    \ value;\n    const Fps result =\n        m1une::fps::polynomial_interpolate_geometric(values,\
    \ initial, ratio);\n    output << result << '\\n';\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/math/fps/polynomial_interpolation_geometric.test.cpp
layout: document
redirect_from:
- /verify/verify/math/fps/polynomial_interpolation_geometric.test.cpp
- /verify/verify/math/fps/polynomial_interpolation_geometric.test.cpp.html
