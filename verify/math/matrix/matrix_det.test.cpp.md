...
data:
  ...
  bundledCode: "#line 1 \"verify/math/matrix/matrix_det.test.cpp\"\n#define PROBLEM\
    ...
    \        return is;\n    }\n};\n\n}  // namespace math\n}  // namespace m1une\n\
    \n\n#line 5 \"verify/math/matrix/matrix_det.test.cpp\"\n\n#line 7 \"verify/math/matrix/matrix_det.test.cpp\"\
    \n\nint main() {\n    using mint = m1une::math::modint998244353;\n    int size;\n\
    \    std::cin >> size;\n    m1une::matrix::Matrix<mint> matrix(size, size);\n\
    \    for (int row = 0; row < size; row++) {\n        for (int col = 0; col < size;\
    \ col++) std::cin >> matrix[row][col];\n    }\n    std::cout << m1une::matrix::determinant(std::move(matrix))\
    \ << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_det\"\n\n#include\
    \ \"../../../math/matrix/linear_algebra.hpp\"\n#include \"../../../math/modint.hpp\"\
    \n\n#include <iostream>\n\nint main() {\n    using mint = m1une::math::modint998244353;\n\
    \    int size;\n    std::cin >> size;\n    m1une::matrix::Matrix<mint> matrix(size,\
    \ size);\n    for (int row = 0; row < size; row++) {\n        for (int col = 0;\
    \ col < size; col++) std::cin >> matrix[row][col];\n    }\n    std::cout << m1une::matrix::determinant(std::move(matrix))\
    \ << '\\n';\n}\n"
  dependsOn:
  - math/matrix/linear_algebra.hpp
  ...
  verifiedWith: []
documentation_of: verify/math/matrix/matrix_det.test.cpp
layout: document
redirect_from:
- /verify/verify/math/matrix/matrix_det.test.cpp
- /verify/verify/math/matrix/matrix_det.test.cpp.html
