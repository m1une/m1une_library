...
data:
  ...
  bundledCode: "#line 1 \"verify/math/matrix/matrix_det_arbitrary_mod.test.cpp\"\n\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 12 \"verify/math/matrix/matrix_det_arbitrary_mod.test.cpp\"\
    \n\nnamespace {\n\ntemplate <class Integer>\nstd::uint64_t naive_determinant_mod(const\
    \ m1une::matrix::Matrix<Integer>& matrix,\n                                  \
    \  std::uint64_t modulus) {\n    const int size = matrix.rows();\n    std::vector<int>\
    \ permutation(size);\n    std::iota(permutation.begin(), permutation.end(), 0);\n\
    \    std::uint64_t result = 0;\n    do {\n        std::uint64_t product = std::uint64_t(1)\
    ...
    \ output;\n    focused_tests();\n\n    int size;\n    std::uint64_t modulus;\n\
    \    input >> size >> modulus;\n    m1une::matrix::Matrix<std::uint64_t> matrix(size,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_det_arbitrary_mod\"\
    ...
    \ Integer>\nstd::uint64_t naive_determinant_mod(const m1une::matrix::Matrix<Integer>&\
    \ matrix,\n                                    std::uint64_t modulus) {\n    const\
    \ int size = matrix.rows();\n    std::vector<int> permutation(size);\n    std::iota(permutation.begin(),\
    \ permutation.end(), 0);\n    std::uint64_t result = 0;\n    do {\n        std::uint64_t\
    \ product = std::uint64_t(1) % modulus;\n        int inversions = 0;\n       \
  ...
  verifiedWith: []
documentation_of: verify/math/matrix/matrix_det_arbitrary_mod.test.cpp
layout: document
redirect_from:
- /verify/verify/math/matrix/matrix_det_arbitrary_mod.test.cpp
- /verify/verify/math/matrix/matrix_det_arbitrary_mod.test.cpp.html
