...
data:
  ...
  bundledCode: "#line 1 \"verify/math/matrix/matrix_rank.test.cpp\"\n#define PROBLEM\
    ...
    \        return is;\n    }\n};\n\n}  // namespace math\n}  // namespace m1une\n\
    \n\n#line 5 \"verify/math/matrix/matrix_rank.test.cpp\"\n\n#line 7 \"verify/math/matrix/matrix_rank.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_rank\"\n\n#include\
    ...
    \ row = 0; row < row_count; row++) {\n        for (int col = 0; col < column_count;\
  ...
  verifiedWith: []
documentation_of: verify/math/matrix/matrix_rank.test.cpp
layout: document
redirect_from:
- /verify/verify/math/matrix/matrix_rank.test.cpp
- /verify/verify/math/matrix/matrix_rank.test.cpp.html
