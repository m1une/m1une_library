...
data:
  ...
  bundledCode: "#line 1 \"verify/math/matrix/bit_matrix_rank.test.cpp\"\n#define PROBLEM\
    ...
    \        return *this;\n    }\n};\n\n}  // namespace utilities\n}  // namespace\
    \ m1une\n\n\n#line 6 \"verify/math/matrix/bit_matrix_rank.test.cpp\"\n\n#line\
    \ 1 \"math/matrix/bit_matrix.hpp\"\n\n\n\n#include <algorithm>\n#include <bit>\n\
    #include <cassert>\n#line 9 \"math/matrix/bit_matrix.hpp\"\n#include <optional>\n\
    #line 11 \"math/matrix/bit_matrix.hpp\"\n#include <string_view>\n#line 13 \"math/matrix/bit_matrix.hpp\"\
    \n#include <vector>\n\nnamespace m1une {\nnamespace matrix {\n\nclass BitMatrix\
    ...
    \    }\n    return result;\n}\n\n}  // namespace matrix\n}  // namespace m1une\n\
    \n\n#line 8 \"verify/math/matrix/bit_matrix_rank.test.cpp\"\n\nint main() {\n\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_rank_mod_2\"\n\n\
    ...
    \ cols;\n    fast_input >> rows >> cols;\n    m1une::matrix::BitMatrix matrix(rows,\
    \ cols);\n    if (cols > 0) {\n        std::string bits;\n        for (int row\
    \ = 0; row < rows; row++) {\n            fast_input >> bits;\n            matrix.set_row(row,\
    \ bits);\n        }\n    }\n    fast_output << m1une::matrix::matrix_rank(std::move(matrix))\
    \ << '\\n';\n}\n"
  ...
  requiredBy: []
  timestamp: '2026-07-15 09:36:42+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/math/matrix/bit_matrix_rank.test.cpp
layout: document
redirect_from:
- /verify/verify/math/matrix/bit_matrix_rank.test.cpp
- /verify/verify/math/matrix/bit_matrix_rank.test.cpp.html
