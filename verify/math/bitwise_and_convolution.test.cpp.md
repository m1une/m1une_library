...
data:
  ...
  bundledCode: "#line 1 \"verify/math/bitwise_and_convolution.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/bitwise_and_convolution\"\n\n#line\
    \ 1 \"math/bitwise_convolution.hpp\"\n\n\n\n#include <cassert>\n#include <cstddef>\n\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 6 \"verify/math/bitwise_and_convolution.test.cpp\"\
    \n\n#line 8 \"verify/math/bitwise_and_convolution.test.cpp\"\n\nint main() {\n\
    \    m1une::utilities::FastInput fast_input;\n    m1une::utilities::FastOutput\
    \ fast_output;\n\n    using mint = m1une::math::modint998244353;\n    int log_size;\n\
    \    fast_input >> log_size;\n    int size = 1 << log_size;\n    std::vector<mint>\
    \ first(size), second(size);\n    for (mint& value : first) fast_input >> value;\n\
    \    for (mint& value : second) fast_input >> value;\n\n    const auto result\
    \ = m1une::math::bitwise_and_convolution(\n        std::move(first),\n       \
