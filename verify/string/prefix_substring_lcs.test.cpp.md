...
data:
  ...
  bundledCode: "#line 1 \"verify/string/prefix_substring_lcs.test.cpp\"\n#define PROBLEM\
    ...
    \    >;\n\n}  // namespace string\n}  // namespace m1une\n\n\n#line 4 \"verify/string/prefix_substring_lcs.test.cpp\"\
    \n\n#line 7 \"verify/string/prefix_substring_lcs.test.cpp\"\n#include <cstdint>\n\
    #include <string>\n#line 10 \"verify/string/prefix_substring_lcs.test.cpp\"\n\n\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 12 \"verify/string/prefix_substring_lcs.test.cpp\"\
    \n\nnamespace {\n\ntemplate <class FirstSequence, class SecondSequence>\nint naive_lcs(\n\
    \    const FirstSequence& first,\n    int first_prefix,\n    const SecondSequence&\
    \ second,\n    int second_left,\n    int second_right\n) {\n    std::vector<int>\
    \ dp(second_right - second_left + 1, 0);\n    for (int i = 0; i < first_prefix;\
    \ i++) {\n        int diagonal = 0;\n        for (int j = second_left; j < second_right;\
    \ j++) {\n            const int up = dp[j - second_left + 1];\n            if\
    \ (first[i] == second[j]) {\n                dp[j - second_left + 1] = diagonal\
    \ + 1;\n            } else {\n                dp[j - second_left + 1] = std::max(\n\
    \                    dp[j - second_left + 1],\n                    dp[j - second_left]\n\
    \                );\n            }\n            diagonal = up;\n        }\n  \
    \  }\n    return dp.back();\n}\n\nvoid test_fixed() {\n    std::string first =\
    \ \"abac\";\n    std::string second = \"cababa\";\n    m1une::string::PrefixSubstringLcs\
    \ solver(first, second);\n    assert(solver.first_size() == 4);\n    assert(solver.second_size()\
    \ == 6);\n    assert(solver.empty());\n    solver.reserve(8);\n\n    assert(solver.add_query(0,\
    \ 0, 6) == 0);\n    assert(solver.add_query(4, 3, 3) == 1);\n    assert(solver.add_query(3,\
    \ 1, 5) == 2);\n    assert(solver.add_query(4, 0, 3) == 3);\n    assert(solver.query_count()\
    ...
    \ (char& value : first) value = char('a' + random() % 4);\n        for (char&\
    \ value : second) value = char('a' + random() % 4);\n\n        m1une::string::PrefixSubstringLcs\
    \ solver(first, second);\n        const int query_count = 100;\n        solver.reserve(query_count);\n\
    \        std::vector<int> expected;\n        expected.reserve(query_count);\n\
    \        for (int query = 0; query < query_count; query++) {\n            const\
    \ int prefix = int(random() % (n + 1));\n            int left = int(random() %\
    \ (m + 1));\n            int right = int(random() % (m + 1));\n            if\
    \ (left > right) std::swap(left, right);\n            assert(solver.add_query(prefix,\
    \ left, right) == query);\n            expected.push_back(\n                naive_lcs(first,\
    \ prefix, second, left, right)\n            );\n        }\n        assert(solver.calculate()\
    \ == expected);\n    }\n}\n\n}  // namespace\n\nint main() {\n    test_fixed();\n\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/prefix_substring_lcs\"\n\
    ...
    \    int second_right\n) {\n    std::vector<int> dp(second_right - second_left\
  ...
  verifiedWith: []
documentation_of: verify/string/prefix_substring_lcs.test.cpp
layout: document
redirect_from:
- /verify/verify/string/prefix_substring_lcs.test.cpp
- /verify/verify/string/prefix_substring_lcs.test.cpp.html
