...
data:
  ...
  bundledCode: "#line 1 \"verify/utilities/int1024.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/many_aplusb\"\n\n#include <cassert>\n#include\
    ...
    }\n\n}  // namespace utilities\n}  // namespace m1une\n\n\n#line 10 \"verify/utilities/int1024.test.cpp\"\
    \n\nnamespace {\n\nusing m1une::utilities::Int1024;\nusing m1une::utilities::parse_int1024;\n\
    \nvoid test_arithmetic_and_parsing() {\n    static_assert(Int1024::bit_width ==\
    \ 1024);\n    static_assert(sizeof(Int1024) == 128);\n    static_assert(Int1024(91)\
    \ / Int1024(10) == Int1024(9));\n    static_assert(Int1024(-91) % Int1024(10)\
    \ == Int1024(-1));\n\n    const std::string ten_to_300 = \"1\" + std::string(300,\
    \ '0');\n    assert(Int1024(ten_to_300).to_string() == ten_to_300);\n    assert(parse_int1024(\"\
    +00042\") == 42);\n\n    Int1024 wrapped = 1;\n    for (int exponent = 0; exponent\
    \ < 1024; ++exponent) wrapped *= 2;\n    assert(wrapped == 0);\n\n    Int1024\
    \ minimum = 1;\n    for (int exponent = 0; exponent < 1023; ++exponent) minimum\
    \ *= 2;\n    assert(minimum.is_negative());\n    assert(-minimum == minimum);\n\
    \n    bool invalid_threw = false;\n    try {\n        static_cast<void>(parse_int1024(\"\
  ...
  verifiedWith: []
documentation_of: verify/utilities/int1024.test.cpp
layout: document
redirect_from:
- /verify/verify/utilities/int1024.test.cpp
- /verify/verify/utilities/int1024.test.cpp.html
