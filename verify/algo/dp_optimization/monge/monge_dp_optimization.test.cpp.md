...
data:
  ...
  bundledCode: "#line 1 \"verify/algo/dp_optimization/monge/monge_dp_optimization.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n\
    #include <cassert>\n#include <iostream>\n#include <limits>\n#include <vector>\n\
    \n#line 1 \"algo/dp_optimization/monge/all.hpp\"\n\n\n\n#line 1 \"algo/dp_optimization/monge/check.hpp\"\
    \n\n\n\n#line 6 \"algo/dp_optimization/monge/check.hpp\"\n\nnamespace m1une {\n\
    namespace monge {\n\ntemplate <class Value>\nbool is_monge(int row_count, int\
    ...
    \ int column) -> const T& { return matrix[row][column]; });\n}\n\ntemplate <class\
    \ T>\nbool is_anti_monge(const std::vector<std::vector<T>>& matrix) {\n    int\
    \ row_count = int(matrix.size());\n    int column_count = row_count == 0 ? 0 :\
    ...
    \n\n\n#line 10 \"verify/algo/dp_optimization/monge/monge_dp_optimization.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n\
    #include <cassert>\n#include <iostream>\n#include <limits>\n#include <vector>\n\
    \n#include \"../../../../algo/dp_optimization/monge/all.hpp\"\n\nvoid test_divide_and_conquer_dp()\
  ...
  verifiedWith: []
documentation_of: verify/algo/dp_optimization/monge/monge_dp_optimization.test.cpp
layout: document
redirect_from:
- /verify/verify/algo/dp_optimization/monge/monge_dp_optimization.test.cpp
- /verify/verify/algo/dp_optimization/monge/monge_dp_optimization.test.cpp.html
