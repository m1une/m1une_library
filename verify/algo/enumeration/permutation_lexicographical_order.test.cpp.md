...
data:
  ...
  bundledCode: "#line 1 \"verify/algo/enumeration/permutation_lexicographical_order.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n\
    #include <cassert>\n#include <cstdint>\n#include <limits>\n#include <numeric>\n\
    #include <random>\n#include <vector>\n\n#line 1 \"algo/enumeration/permutation_lexicographical_order.hpp\"\
    \n\n\n\n#line 5 \"algo/enumeration/permutation_lexicographical_order.hpp\"\n#include\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 13 \"verify/algo/enumeration/permutation_lexicographical_order.test.cpp\"\
    ...
    \        std::vector<int>{0, -1, 2}\n    ));\n    assert(!checked_kth_lexicographical_permutation(3,\
    \ std::uint64_t(6)));\n    assert(!checked_kth_lexicographical_permutation(\n\
    \        -1, std::uint64_t(0)\n    ));\n\n    assert(\n        checked_permutation_lexicographical_rank(std::vector<int>())\
    \ ==\n        std::uint64_t(0)\n    );\n    assert(\n        checked_kth_lexicographical_permutation(0,\
    \ std::uint64_t(0)) ==\n        std::vector<int>()\n    );\n\n    std::vector<int>\
    \ descending_twenty(20);\n    std::iota(descending_twenty.rbegin(), descending_twenty.rend(),\
    \ 0);\n    assert(\n        checked_permutation_lexicographical_rank(descending_twenty)\
    \ ==\n        std::uint64_t(2432902008176640000ULL - 1)\n    );\n\n    std::vector<int>\
    \ descending_twenty_one(21);\n    std::iota(\n        descending_twenty_one.rbegin(),\
    \ descending_twenty_one.rend(), 0\n    );\n    assert(!checked_permutation_lexicographical_rank(\n\
    \        descending_twenty_one\n    ));\n\n    const std::uint64_t largest =\n\
    \        std::numeric_limits<std::uint64_t>::max();\n    assert(!checked_kth_lexicographical_permutation(20,\
    \ largest));\n    const auto large = checked_kth_lexicographical_permutation(21,\
    \ largest);\n    assert(large);\n    assert(checked_permutation_lexicographical_rank(*large)\
    \ == largest);\n\n    const auto narrow =\n        checked_kth_lexicographical_permutation(300,\
    ...
    \ permutation =\n            m1une::algo::kth_lexicographical_permutation(size,\
    \ rank);\n        assert(\n            m1une::algo::permutation_lexicographical_rank(permutation)\
  ...
  verifiedWith: []
documentation_of: verify/algo/enumeration/permutation_lexicographical_order.test.cpp
layout: document
redirect_from:
- /verify/verify/algo/enumeration/permutation_lexicographical_order.test.cpp
- /verify/verify/algo/enumeration/permutation_lexicographical_order.test.cpp.html
