...
data:
  ...
  bundledCode: "#line 1 \"verify/algo/sequence/merge_intervals.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n\
    #include <cassert>\n#include <random>\n#include <utility>\n#include <vector>\n\
    \n#line 1 \"algo/sequence/merge_intervals.hpp\"\n\n\n\n#line 6 \"algo/sequence/merge_intervals.hpp\"\
    \n#include <cstddef>\n#line 9 \"algo/sequence/merge_intervals.hpp\"\n\nnamespace\
    \ m1une {\nnamespace algo {\n\n// Returns the union of half-open intervals as\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 11 \"verify/algo/sequence/merge_intervals.test.cpp\"\
    ...
    \ right = minimum + int(random() % (maximum - minimum + 1));\n            if (right\
    ...
    \ = 0; index < int(merged.size()); ++index) {\n            const auto [left, right]\
    \ = merged[index];\n            assert(left < right);\n            if (index >\
    \ 0) assert(merged[index - 1].second < left);\n        }\n\n        std::vector<bool>\
    \ merged_covered(maximum - minimum, false);\n        for (const auto& [left, right]\
    \ : merged) {\n            for (int point = left; point < right; ++point) {\n\
  ...
  verifiedWith: []
documentation_of: verify/algo/sequence/merge_intervals.test.cpp
layout: document
redirect_from:
- /verify/verify/algo/sequence/merge_intervals.test.cpp
- /verify/verify/algo/sequence/merge_intervals.test.cpp.html
