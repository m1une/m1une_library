...
data:
  ...
  bundledCode: "#line 1 \"verify/ds/segtree/persistent_dynamic_lazy_segtree.test.cpp\"\
    ...
    \ predicate);\n    }\n};\n\n}  // namespace ds\n}  // namespace m1une\n\n\n#line\
    \ 4 \"verify/ds/segtree/persistent_dynamic_lazy_segtree.test.cpp\"\n\n#line 1\
    ...
    \ == 0);\n    assert(second.max_right(-30, [](const AM::value_type& x) { return\
    \ x.sum <= 20; }) == -4);\n    assert(second.min_left(40, [](const AM::value_type&\
    \ x) { return x.sum <= 20; }) == 14);\n    assert(base.node_count() == branch.node_count());\n\
