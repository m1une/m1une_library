...
data:
  ...
  bundledCode: "#line 1 \"verify/ds/segtree/range_update_range_product.test.cpp\"\n\
    ...
    \ sm);\n        } while ((r & -r) != r);\n        return 0;\n    }\n};\n\n}  //\
    \ namespace ds\n}  // namespace m1une\n\n\n#line 5 \"verify/ds/segtree/range_update_range_product.test.cpp\"\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 15 \"verify/ds/segtree/range_update_range_product.test.cpp\"\
    ...
    \     auto all = seg.all_prod();\n            assert(all.product == naive_product(values,\
    ...
    \ int c, d;\n            fast_input >> c >> d;\n            seg.apply(left, right,\
    \ Function{Mint(c), Mint(d)});\n        } else {\n            int x;\n       \
  ...
  verifiedWith: []
documentation_of: verify/ds/segtree/range_update_range_product.test.cpp
layout: document
redirect_from:
- /verify/verify/ds/segtree/range_update_range_product.test.cpp
- /verify/verify/ds/segtree/range_update_range_product.test.cpp.html
