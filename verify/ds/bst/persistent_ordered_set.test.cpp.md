...
data:
  ...
  bundledCode: "#line 1 \"verify/ds/bst/persistent_ordered_set.test.cpp\"\n#define\
    ...
    \ fast_output;\n\n    m1une::ds::PersistentOrderedSet<int> pointer_test = {1,\
    \ 3, 5};\n    const int* stable_pointer = pointer_test.lower_bound(3);\n    auto\
    \ pointer_test_next = pointer_test;\n    for (int x = 10; x < 1000; x++) pointer_test_next\
    \ = pointer_test_next.insert(x);\n    assert(stable_pointer && *stable_pointer\
