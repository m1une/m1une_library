...
data:
  ...
  bundledCode: "#line 1 \"verify/ds/queue/persistent_queue.test.cpp\"\n#define PROBLEM\
    ...
    \ {\n        write(value);\n        return *this;\n    }\n};\n\n}  // namespace\
    \ utilities\n}  // namespace m1une\n\n\n#line 5 \"verify/ds/queue/persistent_queue.test.cpp\"\
    \n\n#line 11 \"verify/ds/queue/persistent_queue.test.cpp\"\n#include <vector>\n\
    ...
    \        fast_input >> type >> base;\n        const auto& source = versions[base\
    \ + 1];\n        if (type == 0) {\n            int value = 0;\n            fast_input\
  ...
  verifiedWith: []
documentation_of: verify/ds/queue/persistent_queue.test.cpp
layout: document
redirect_from:
- /verify/verify/ds/queue/persistent_queue.test.cpp
- /verify/verify/ds/queue/persistent_queue.test.cpp.html
