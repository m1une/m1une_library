...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"geometry/detail/floating_predicate.hpp\"\n\n\n\nnamespace\
  ...
  code: "#ifndef M1UNE_GEOMETRY_DETAIL_FLOATING_PREDICATE_HPP\n#define M1UNE_GEOMETRY_DETAIL_FLOATING_PREDICATE_HPP\
    \ 1\n\nnamespace m1une {\nnamespace geometry {\nnamespace predicate_detail {\n\
    \ntemplate <typename T>\nconstexpr T absolute(T value) {\n    return value < T(0)\
...
layout: document
redirect_from:
- /library/geometry/detail/floating_predicate.hpp
- /library/geometry/detail/floating_predicate.hpp.html
