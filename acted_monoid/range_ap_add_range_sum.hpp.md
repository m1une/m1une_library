...
data:
  ...
  bundledCode: "#line 1 \"acted_monoid/range_ap_add_range_sum.hpp\"\n\n\n\n#include\
    ...
    \ value_type mapping(const operator_type& f, const value_type& x, long long ord)\
    \ {\n        return {x.sum + f.first * (x.ord_sum + T(ord) * T(x.size)) + f.second\
    \ * T(x.size), x.size, x.ord_sum};\n    }\n\n    static constexpr operator_type\
