...
| Category | Headers |
| --- | --- |
| [`sequence/`](sequence/) | `lis.hpp`, `inversion_count.hpp`, `merge_intervals.hpp`, `non_adjacent_selection.hpp`, `number_of_subsequences.hpp`, `run_length_encoding.hpp`, `subset_sum.hpp`, and `all.hpp` |
...
| [`enumeration/`](enumeration/) | `gray_code.hpp`, `submask.hpp`, `combination.hpp`, `permutation_lexicographical_order.hpp`, `segtree_range.hpp`, and `all.hpp` |
