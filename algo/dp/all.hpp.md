...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"algo/dp/all.hpp\"\n\n\n\n#line 1 \"algo/dp/knapsack.hpp\"\
    \n\n\n\n#include <algorithm>\n#include <cassert>\n#include <cstddef>\n#include\
    \ <deque>\n#include <limits>\n#include <vector>\n\nnamespace m1une {\nnamespace\
    \ algo {\n\ninline std::vector<char> subset_sum_reachable(const std::vector<int>&\
  ...
  code: '#ifndef M1UNE_ALGO_DP_ALL_HPP

    #define M1UNE_ALGO_DP_ALL_HPP 1


    #include "knapsack.hpp"


    #endif  // M1UNE_ALGO_DP_ALL_HPP
  ...
  verifiedWith: []
documentation_of: algo/dp/all.hpp
layout: document
...
`algo/dp/all.hpp` includes domain-neutral dynamic-programming helpers. The
public namespace is `m1une::algo`.

Convex DP optimizations live under `convex/`.

## Included Headers

| Header | Contents |
| --- | --- |
| `algo/dp/knapsack.hpp` | Subset-sum and knapsack helper routines. |
