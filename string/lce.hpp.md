...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"string/lce.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n\
    ...
    \    }\n};\n\n}  // namespace string\n}  // namespace m1une\n\n\n"
  code: "#ifndef M1UNE_STRING_LCE_HPP\n#define M1UNE_STRING_LCE_HPP 1\n\n#include\
    \ <algorithm>\n#include <cassert>\n#include <string>\n#include <utility>\n#include\
    ...
    \    }\n    }\n\n   public:\n    LCE() = default;\n\n    explicit LCE(const Sequence&\
    \ sequence) : _sequence(sequence) {\n        build();\n    }\n\n    explicit LCE(Sequence&&\
