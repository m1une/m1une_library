...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/dag_path_cover.hpp\"\n\n\n\n#include <cassert>\n#include\
    ...
    \ int(paths.size());\n    }\n};\n\ntemplate <class T>\nstd::optional<DagPathCoverResult>\
    \ minimum_dag_path_cover(const Graph<T>& g) {\n    const int n = g.size();\n \
  ...
  code: "#ifndef M1UNE_GRAPH_DAG_PATH_COVER_HPP\n#define M1UNE_GRAPH_DAG_PATH_COVER_HPP\
    \ 1\n\n#include <cassert>\n#include <optional>\n#include <vector>\n\n#include\
