...
| `ds/range_query/` | Objects built for repeated range queries, including cumulative sums, range LIS/modes, Fenwick trees, static sparse-table queries, and wavelet matrices. |
