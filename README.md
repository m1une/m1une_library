...
| `ds/range_query/` | Objects built for repeated range queries, including cumulative sums, range LIS, Fenwick trees, static sparse-table queries, and wavelet matrices. |
