...
| `geometry/` | 2D points, lines, rays, segments, perpendicular bisectors, polygons, convex decomposition, rectangle-union area, convex hulls, Voronoi diagrams, half-plane intersection, lattice-point counting, and circles. |
