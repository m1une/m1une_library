...
| `string/` | Z/KMP, wildcard matching, edit distance, Manacher, palindrome lexicographic rank/select, minimum rotation, Lyndon factorization, run enumeration, longest common extension/subsequence/substring, eertrees, suffix automata/arrays, tries, Aho-Corasick, and string hashes. |
