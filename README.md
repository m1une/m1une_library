...
| `math/` | Base and Gray-code conversion, repunits, cyclotomic polynomials, extended GCD, modular arithmetic, Lucas binomials, tetration, Stern-Brocot paths, combinatorial sequences, sieves, factorization, CRT, and floor sums. |
