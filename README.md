...
| `string/` | Z/KMP, edit distance, Manacher, Lyndon factorization, longest common extension/substring, eertrees, suffix automata/arrays, tries, Aho-Corasick, and string hashes. |
